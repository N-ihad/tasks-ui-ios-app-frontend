//
//  ScaleParameterSelectionViewController.swift
//  tasks_UI
//
...
//============================================================================
class ScaleParameterSelectionViewController: UIViewController
{
    ...
    func onGenerateImage()
    {
        ...
        AF.request(
            "http://127.0.0.1:5000/generate-scale-parameter-selection-image",
            method: .get,
    ...
    func style()
    {
        title = "Scale Parameter Selection"
