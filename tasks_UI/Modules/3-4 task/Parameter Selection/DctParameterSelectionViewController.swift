//
//  DctParameterSelectionViewController.swift
//  tasks_UI
//
...
//============================================================================
class DctParameterSelectionViewController: UIViewController
{
    ...
    func onGenerateImage()
    {
        ...
        AF.request(
            "http://127.0.0.1:5000/generate-dct-parameter-selection-image",
            method: .get,
