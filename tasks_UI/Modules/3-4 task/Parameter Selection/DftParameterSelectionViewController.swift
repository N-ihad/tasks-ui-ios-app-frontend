//
//  DftParameterSelectionViewController.swift
//  tasks_UI
//
...
//============================================================================
class DftParameterSelectionViewController: UIViewController
{
    ...
    func onGenerateImage()
    {
        ...
        AF.request(
            "http://127.0.0.1:5000/generate-dft-parameter-selection-image",
            method: .get,
