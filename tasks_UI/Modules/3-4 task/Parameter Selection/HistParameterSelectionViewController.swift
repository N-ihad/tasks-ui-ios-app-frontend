//
//  HistParameterSelectionViewController.swift
//  tasks_UI
//
...
//============================================================================
class HistParameterSelectionViewController: UIViewController
{
    ...
    func onGenerateImage()
    {
        ...
        AF.request(
            "http://127.0.0.1:5000/generate-hist-parameter-selection-image",
            method: .get,
    ...
    func style()
    {
        title = "Histogram Parameter Selection"
